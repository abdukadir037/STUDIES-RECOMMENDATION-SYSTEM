  ...
  $("#form").submit(function (event) {
    ...
    $.ajax({
      ...
      success: function (response) {
          ...
          // Update Total Predictions and Total Users on the Dashboard
          $("#total_predictions").text(response.total_predictions);
...
//       // Set the new image width to match the PDF width
//       var newImgWidth = pdfWidth;
//       var newImgHeight = pdfWidth * aspectRatio;

//       // The height of the visible content on the PDF page
//       var heightOfOnePage = pdfHeight;
//       var totalPages = Math.ceil(newImgHeight / heightOfOnePage);

//       for (var i = 0; i < totalPages; i++) {
//           var sourceY = i * heightOfOnePage;
...
//               "PNG",
//               0,
//               -sourceY,  // Move the image up by the height of the previous page
//               newImgWidth,
//               newImgHeight
//           );
//       }
...
function exportStatement() {
  ...
  html2canvas(printArea, { scale: 2, willReadFrequently: true }).then((canvas) => {
      var imgData = canvas.toDataURL("image/png");
